    ...
    def init_ui(self):
        ...
        car_ascii = """
           ...
           |_____|___|_____|
            (o)       (o)
        """
        car_art.setText(car_ascii)
        car_art.setAlignment(Qt.AlignmentFlag.AlignCenter)
        car_art.setStyleSheet("color: #666666; font-family: monospace; font-size: 10px;")
        layout.addWidget(car_art)
